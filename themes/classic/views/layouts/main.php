...
<body>
				...
				<ul class='main-nav'>
					...
					<li <?php if(!empty($this->navigationSelectedIndex) && $this->navigationSelectedIndex == Yii::app()->params['NAV_USER_MANAGER_INDEX']){echo "class='active'";} ?>>
						<a href="#" data-toggle="dropdown" class='dropdown-toggle'>
							<span><?php echo Yii::t(Yii::app()->params['TRANSLATE_FILE'],'User')?></span>
							...
							<li>
								<a href="<?php echo Yii::app()->createUrl('user');?>">
									<?php echo Yii::t(Yii::app()->params['TRANSLATE_FILE'],'User Manager')?>
                                        ...
                                        <li <?php if(!empty($this->navigationSelectedIndex) && $this->navigationSelectedIndex == Yii::app()->params['NAV_CATEGORY_MANAGER_INDEX']){echo "class='active'";} ?>>
						<a href="#" data-toggle="dropdown" class='dropdown-toggle'>
							<span><?php echo Yii::t(Yii::app()->params['TRANSLATE_FILE'],'Category')?></span>
							<span class="caret"></span>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a href="<?php echo Yii::app()->createUrl('category');?>">
	    ...
	    <footer>
	    	<div class="container-fluid" id="content">
	    		<div id="copyright">
	    			<span>&copy; 2013 - <?php echo date('Y') ?> - Kensway - <?php echo Yii::t(Yii::app()->params['TRANSLATE_FILE'],'Appus.') ?></span>
	    		</div>
	    	</div>
	    </footer>
    </body>
